...
public class PqcQualityReportDetails implements Serializable {
	
    /**
	 * 
	 */
	private static final long serialVersionUID = -9210975576013365752L;

	private Integer id;

    private Integer pqcQualityReportId;
    ...
    public PqcQualityReportDetails(Integer id, Integer pqcQualityReportId, String inspTypeCode, String inspTypeName, Integer inspTypeSort, String inspDescCode, String inspDescName, Integer inspDescSort, String inspResult, String remarks, String crtId, Date crtDt, String uptId, Date uptDt) {
        this.id = id;
        this.pqcQualityReportId = pqcQualityReportId;
    ...
    public PqcQualityReportDetails() {
        super();
    }
    ...
    public Integer getPqcQualityReportId() {
        return pqcQualityReportId;
    }

    public void setPqcQualityReportId(Integer pqcQualityReportId) {
        this.pqcQualityReportId = pqcQualityReportId;
    }
    ...
    public String toString() {
        ...
        sb.append(", pqcQualityReportId=").append(pqcQualityReportId);
