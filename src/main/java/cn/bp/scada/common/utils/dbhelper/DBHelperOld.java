...
public class DBHelperOld {
	...
	private static final String URL = "jdbc:mysql://10.50.0.94:3306/testlog";
	private static final String USER = "qryinfo";
	private static final String PASSWORD = "qryinfo123";*/
	...
	public boolean excuteUpdate(String sql, List<Object> params) {
		...
		ResultSet rs = null;
		try {
			conn = dbtool.getDateSource().getConnection();
